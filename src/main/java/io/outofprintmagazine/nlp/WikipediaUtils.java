...
//	}
	...
	private WikipediaUtils() throws IOException {
		super();

	}
	
	private static WikipediaUtils single_instance = null; 

    public static WikipediaUtils getInstance() throws IOException { 
        if (single_instance == null) 
            single_instance = new WikipediaUtils(); 
