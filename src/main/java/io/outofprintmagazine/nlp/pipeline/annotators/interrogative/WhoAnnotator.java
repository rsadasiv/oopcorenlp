...
public class WhoAnnotator extends AbstractTreeAnnotator implements Annotator, OOPAnnotator {
	...
	public WhoAnnotator() {
		super();
		this.setTags(Arrays.asList("who"));
	}
	
	public WhoAnnotator(Properties properties) {
		this();
	...
	public Class getAnnotationClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPWhoAnnotation.class;
	}
	...
	public String getDescription() {
		return "Constituency Parse: SBARQ, WHNP || WHADVP, who. https://gist.github.com/nlothian/9240750"; 
	}
}
