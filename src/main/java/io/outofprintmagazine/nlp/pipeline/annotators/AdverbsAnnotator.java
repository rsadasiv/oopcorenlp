...
public class AdverbsAnnotator extends AbstractAggregatePosAnnotator implements Annotator, OOPAnnotator {
	...
	public Class getAggregateClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPAdverbsAnnotationAggregate.class;
	}
