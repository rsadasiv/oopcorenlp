...
public class WhereAnnotator extends AbstractTreeAnnotator implements Annotator, OOPAnnotator {
	
	@SuppressWarnings("unused")
	private static final Logger logger = LogManager.getLogger(WhereAnnotator.class);
	...
	public WhereAnnotator() {
		super();
		this.setTags(Arrays.asList("where"));
	}
	
	public WhereAnnotator(Properties properties) {
		this();
	...
	public Class getAnnotationClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPWhereAnnotation.class;
	}
	...
	public String getDescription() {
		return "Constituency Parse: SBARQ, WHNP || WHADVP, when. https://gist.github.com/nlothian/9240750"; 
	}
}
