...
public class ColorsAnnotator extends AbstractAggregatePosAnnotator implements Annotator, OOPAnnotator {
	...
	public Class getAggregateClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPColorsAnnotationAggregate.class;
	}
