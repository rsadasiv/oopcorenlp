...
public class WhyAnnotator extends AbstractTreeAnnotator implements Annotator, OOPAnnotator {
	
	@SuppressWarnings("unused")
	private static final Logger logger = LogManager.getLogger(WhyAnnotator.class);
	...
	public WhyAnnotator() {
		super();
		this.setTags(Arrays.asList("why"));
	}
	
	public WhyAnnotator(Properties properties) {
		this();
	...
	public Class getAnnotationClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPWhyAnnotation.class;
	}
	...
	public String getDescription() {
		return "Constituency Parse: SBARQ, WHNP || WHADVP, why. https://gist.github.com/nlothian/9240750"; 
	}
}
