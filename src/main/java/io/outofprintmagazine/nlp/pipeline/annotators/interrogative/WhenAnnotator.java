...
public class WhenAnnotator extends AbstractTreeAnnotator implements Annotator, OOPAnnotator {
	
	@SuppressWarnings("unused")
	private static final Logger logger = LogManager.getLogger(WhenAnnotator.class);
	...
	public WhenAnnotator() {
		super();
		this.setTags(Arrays.asList("when"));
	}
	
	public WhenAnnotator(Properties properties) {
		this();
	...
	public Class getAnnotationClass() {
		return io.outofprintmagazine.nlp.pipeline.OOPAnnotations.OOPWhenAnnotation.class;
	}
