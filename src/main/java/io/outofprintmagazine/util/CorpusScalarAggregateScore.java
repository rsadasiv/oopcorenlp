...
public class CorpusScalarAggregateScore {
	
	@SuppressWarnings("unused")
	private static final Logger logger = LogManager.getLogger(CorpusScalarAggregateScore.class);
	
	public CorpusScalarAggregateScore() {
		super();
	}
	
	public CorpusScalarAggregateScore(String name) {
		this();
		this.setName(name);
	}
	...
	public CorpusScalarAggregateScore(String name, Map<String, BigDecimal> rawScores, BigDecimal normalizer) {
		this(name);
		if (rawScores.size() == 0) {
			return;
		}
